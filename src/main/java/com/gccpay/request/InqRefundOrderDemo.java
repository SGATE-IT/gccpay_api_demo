...
public class InqRefundOrderDemo {
    ...
    public static void main(String[] args) {
        String url= "https://api-dev.gccpay.cn/pay/merchant/inquiryRefund";
        ResponseEntity<String> response = null;
        try {
            InqRefundOrderEntity inqRefundOrder = new InqRefundOrderEntity();
            inqRefundOrder.setMerchantId("M96620240924161327000862");
            inqRefundOrder.setMerRefundOrderId("");
            inqRefundOrder.setRefundOrderId("REF250306123725194030261");
            ...
            String signature = RSAUtils.sign(JSONObject.toJSONString(inqRefundOrder), privateKey);
            ...
            String encrypt = AESUtils.encrypt(JSONObject.toJSONString(inqRefundOrder), aeskey);
