...
public class CreateOrderDemo {
    ...
    public static void main(String[] args) {
        ...
        try {
            ...
            createOrder.setMerchantId("M96620240924161327000862");
            createOrder.setMerOrderId("202501231241084485484");
            createOrder.setSubMerId("");
            createOrder.setOrderType("online_payin");
            createOrder.setPaymentType("stcpay,cardpay,applepay");
            createOrder.setOrderAmt(new BigDecimal("130"));
            createOrder.setOrderCurrency("SAR");
            createOrder.setExpireTime(30);
            createOrder.setFrontRedirectUrl("http://localhost:8080/pay/callback");
            createOrder.setOrderDesc("Test order");
            ...
            productInfo.setProductUnitPrice(new BigDecimal("100"));
            productInfo.setProductQuantity(1);
            productInfo.setProductCurrency("SAR");
            productInfo.setProductDesc("TEST");
            productInfo.setProductAvatarUrl("https://google.com");
            ...
            productInfo2.setProductUnitPrice(new BigDecimal("30"));
            productInfo2.setProductQuantity(2);
            productInfo2.setProductCurrency("SAR");
            productInfo2.setProductDesc("TEST virtual");
            productInfo2.setProductAvatarUrl("https://baidu.com");
            ...
            createOrder.getDeliveryInfo().setFirstName("lala");
            createOrder.getDeliveryInfo().setLastName("Mr");
            createOrder.getDeliveryInfo().setAddress("China beijing chaoyang");
            createOrder.getDeliveryInfo().setCity("beijing");
            createOrder.getDeliveryInfo().setCountry("china");
            createOrder.getDeliveryInfo().setPhone("5001999921");
            createOrder.getDeliveryInfo().setZipCode("100000");
            ...
            headers.set("merchantKeyId", "12345678901");
